...
def define_flags():
  flags.DEFINE_string("model_file", None, "ghj")
  flags.DEFINE_string("label_file", None, "jhg")
  flags.DEFINE_string("export_directory", None, "hgj")
...
_MODEL_INFO = {
    "model_1_0.tflite":
        ModelSpecificInfo(
            name="Polish Banknotes image classifier",
            version="v2",
            image_width=224,
            image_height=224,
            image_min=0,
